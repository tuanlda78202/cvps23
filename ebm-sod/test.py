...
for dataset in test_datasets:
    ...
    for i in tqdm(range(test_loader.size), desc=dataset):
        ...
        for iter in range(opt.iter_num):
            ...
            z_e_0 = generator(image, z_prior0, z_post0, y=None, prior_z_flag=True, istraining = False)
            ...
            generator_pred = generator.forward(image, z_e_noise, z_post0, y=None, prior_z_flag=False, istraining = False)
            res = generator_pred
